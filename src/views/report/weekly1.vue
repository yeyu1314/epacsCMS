    ...
    <div style="margin-top:15px" v-show="tabularData">
      <template>
        <el-table :data="listArr" border :cell-style="getRowClass" :header-cell-style="getClass" style="width: 100%;">
          <el-table-column fixed="left" prop="orgName" label="检测站点" align="center" min-width="120"></el-table-column>
          <el-table-column prop="checkCount" :label="label1" align="center" min-width="80">
          ...
          <el-table-column prop="repairCount" :label="label2" align="center" min-width="80">
          ...
          <el-table-column prop="firstAmt" :label="label5" align="center" min-width="80">
          ...
          <el-table-column prop="checktotal" label="合计" align="center" min-width="80"></el-table-column>
          <el-table-column
            prop="avgCheck"
            label="日均台次"
            :render-header="renderheader"
            :formatter="avgCheckType"
            align="center"
            min-width="80"
          ></el-table-column>
          <el-table-column
...
export default {
  ...
  methods: {
    ...
    getRowClass({ row, column, rowIndex, columnIndex }) {
      if (columnIndex==0||columnIndex==2||columnIndex==4||columnIndex==6||columnIndex==8||columnIndex==10||columnIndex==11||columnIndex==12||columnIndex==13 ) {
          return {
            "border-right-color": "#000"
          };
      }
