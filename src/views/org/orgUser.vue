<template>
  <div id="userList">
    <div class="searchContent">
      ...
      <el-input placeholder="请输入检测中心" v-model="nickName" clearable></el-input>
      <el-input placeholder="请输入检测中心用户名" v-model="userName" clearable></el-input>
