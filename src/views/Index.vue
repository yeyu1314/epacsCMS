  ...
  data() {
    return {
      ...
      AITitles: [
        {
          id: 1,
          name: require("../assets/img/re_data.png"),
          flag: false,
          path: "/modalUrlConfig",
        ...
        {
          id: 2,
          name: require("../assets/img/distinguish.png"),
          flag: false,
          path: "/distinguish",
        ...
        {
          id: 3,
          name: require("../assets/img/algorithm.png"),
          flag: false,
          path: "/distinguish",
          pathName: "distinguish",
          type:2
      ...
      dataTitles: [
        {
          id: 1,
          name: require("../assets/img/image_retrieval.png"),
          flag: false,
          path: "/historydata",
          type: "primary"
        },
        {
          id: 2,
          name: require("../assets/img/analysis.png"),
          flag: false,
          path: "/orderReport",
          type: "success"
        },
        {
          id: 3,
          name: require("../assets/img/big_data.png"),
          flag: false,
          path: "/bigdata",
          type: "warning"
        }
