...
export const getDetectionOrderEdutListData = (param, data) => net.request('admin/order/queryListPage', 'post', param, data) // 获取 待编辑报告 列表
...
export const getDetectionOrderListData = (param, data) => net.request('admin/order/queryListPage', 'post', param, data) // 获取 待检测工单 / 待审核报告 / 治疗单确认  列表
